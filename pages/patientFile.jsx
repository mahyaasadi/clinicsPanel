          ...
          <div className="content container-fluid">
            <div className="card-body p-4 dir-rtl">
              <div className="d-flex flex-col-md gap-2 justify-between">
                <div
                  className="btn-group-vertical border-gray w-100"
                ...
                >
                  <button
                    ...
                    className="btn patientFileQBtn clipboard patientFileQBtnHover"
                  ...
                  <button
                    ...
                    data-pr-position="right"
                  >
                    {patientData.InsuranceType == "2" ||
                    patientData.Insurance == "2" ? (
                      <svg
                        version="1.0"
