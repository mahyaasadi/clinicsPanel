    ...
    <>
      <div className="reciptPrintHeader reciptLogoContainer font-11 p-3">
        ...
        <div className="row justify-between font-11">
          ...
          {/* <div className="text-end font-11 fw-bold">
            خدمات :
          ...
          <div className="row justify-between font-11">
            <div className="col-7">
              <p className="mb-1">
                جمع هزینه خدمات :{" "}
                {data?.Calculated?.TotalPrice?.toLocaleString()} ریال
              </p>
              <p className="mb-1">
              ...
              <p className="mb-1">
                سهم پرداختی بیمار :{" "}
                {data?.Calculated?.TotalPC?.toLocaleString()} ریال
              </p>
            ...
            <div dir="rtl" className="col-4 fw-bold text-end">
              مهر و امضا :
            </div>
          </div>
