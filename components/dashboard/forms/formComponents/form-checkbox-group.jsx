const FormCheckbox = ({ data, disabled, defaultValue, formDirection }) => {
  return (
    <>
      ...
      <div
        className={`${data.inline && "row"} ${data.className} mb-3 ${formDirection ? "dir-ltr" : "dir-rtl"
          }`}
      >
        {data?.values.map((option, index) => (
          <div className="col-auto" key={index}>
            <div
              className={`form-check  ${formDirection ? "form-check-left" : ""
                }`}
            ...
            >
              ...
              <input
                ...
                value={option.value}
                id={option.value}
                className={`form-check-input  ${formDirection ? "form-check-input-left" : ""
                  }`}
                defaultChecked={
                  defaultValue
