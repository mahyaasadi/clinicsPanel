          ...
          {!row.Patient ? (
            ...
            <div className="d-flex align-items-center gap-2">
              ...
              >
                <img
                  src={
                    "https://irannobat.ir/images/Avatar/" + row.Patient.Avatar
                  }
                  alt="patientAvatar"
                  style={{
                    width: "35px",
      ...
      cell: (row) =>
        row.Patient ? (
          <div className="actions d-flex">
            <div>
              <Link
                className="btn btn-sm btn-outline-primary btn-border-l receptionBtn d-flex align-items-center m-1"
            ...
            <div>
              <button
                ...
                onClick={() => openAppointmentModal(row.Patient._id)}
              >
          ...
          <div>
            <button
              ...
              className="btn btn-sm btn-outline-primary addPatientBtn d-flex align-items-center"
              data-pr-position="right"
            >
              <Tooltip target=".addPatientBtn">افزودن اطلاعات بیمار</Tooltip>
