...
const EditPatientInfoModal = ({ showModal, handleClose, handleChangePatientInfo, data }) => {
    const [selectedTab, setSelectedTab] = useState('Tel');
    ...
    return (
        <Modal show={showModal} onHide={handleClose} size='lg' centered>
            <Modal.Header closeButton>
                <Modal.Title>
                    <p className="mb-0 text-secondary font-14 fw-bold">تغییر اطلاعات بیمار</p>
                </Modal.Title>
            </Modal.Header>
            <Modal.Body>
                ...
                <div className="tab-content">
                    <div className="tab-pane show active" id="solid-rounded-tab1">
                        <Form.Group controlId="patientName">
                            ...
                            <Form.Control type="text" className='rounded' onChange={handleInputChange} defaultValue={data.Name} />
                        </Form.Group>
                    </div>
                    <div className="tab-pane" id="solid-rounded-tab2">
                        <Form.Group controlId="patientAge">
                            ...
                            <Form.Control type="text" className='rounded' onChange={handleInputChange} defaultValue={data.Age} />
                        </Form.Group>
                    </div>
                    <div className="tab-pane" id="solid-rounded-tab3">
                        <Form.Group controlId="patientGender">
                            ...
                            <Form.Control type="text" className='rounded' onChange={handleInputChange} defaultValue={data.Gender} />
                        </Form.Group>
                    </div>
                    <div className="tab-pane" id="solid-rounded-tab4">
                        <Form.Group controlId="patientPhoneNumber">
                            ...
                            <Form.Control type="tel" className='rounded' onChange={handleInputChange} defaultValue={data.Tel} />
                        </Form.Group>
                    </div>
                    <div className="tab-pane" id="solid-rounded-tab5">
                        <Form.Group controlId="patientNID">
                            ...
                            <Form.Control type="text" dir='ltr' className='rounded' onChange={handleInputChange} defaultValue={data.NationalID} />
                        </Form.Group>
                    </div>
                </div>
            </Modal.Body>
